 ...
 * <!-- end-user-doc -->
 * @see AAS.AASPackage#getEntityType()
 * @model
 * @generated
 */
public enum EntityType implements Enumerator {
	 ...
	 * @ordered
	 */
	SELF_MANAGED_ENTITY(0, "SelfManagedEntity", "SelfManagedEntity"),
	 ...
	 * @ordered
	 */
	CO_MANAGED_ENTITY(1, "CoManagedEntity", "CoManagedEntity");
	 ...
	 * @ordered
	 */
	public static final int SELF_MANAGED_ENTITY_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int CO_MANAGED_ENTITY_VALUE = 1;
