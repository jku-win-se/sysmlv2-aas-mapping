 ...
 * </p>
 * <ul>
 *   <li>{@link AAS.impl.EndpointImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link AAS.impl.EndpointImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link AAS.impl.EndpointImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndpointImpl extends MinimalEObjectImpl.Container implements Endpoint {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AASPackage.ENDPOINT__NAME, oldName, name));
	}
