 ...
 * </p>
 * <ul>
 *   <li>{@link AAS.impl.ReferenceImpl#getKey <em>Key</em>}</li>
 *   <li>{@link AAS.impl.ReferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends MinimalEObjectImpl.Container implements Reference {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AASPackage.REFERENCE__NAME, oldName, name));
	}
