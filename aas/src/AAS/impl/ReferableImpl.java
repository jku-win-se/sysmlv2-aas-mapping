 ...
 * </p>
 * <ul>
 *   <li>{@link AAS.impl.ReferableImpl#getIdShort <em>Id Short</em>}</li>
 *   <li>{@link AAS.impl.ReferableImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link AAS.impl.ReferableImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ReferableImpl extends HasExtensionsImpl implements Referable {
	/**
	...
	public void setIdShort(String newIdShort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AASPackage.REFERABLE__ID_SHORT, oldIdShort, idShort));
	}
