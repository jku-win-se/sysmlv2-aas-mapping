 ...
 * </p>
 * <ul>
 *   <li>{@link AAS.impl.CapabilityImpl#getSubmodelelement <em>Submodelelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityImpl extends SubmodelElementImpl implements Capability {
	...
	public EList<SubmodelElement> getSubmodelelement() {
		if (submodelelement == null) {
			submodelelement = new EObjectContainmentEList<SubmodelElement>(SubmodelElement.class, this, AASPackage.CAPABILITY__SUBMODELELEMENT);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ComposableElement.class) {
			switch (derivedFeatureID) {
				case AASPackage.CAPABILITY__SUBMODELELEMENT: return AASPackage.COMPOSABLE_ELEMENT__SUBMODELELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ComposableElement.class) {
			switch (baseFeatureID) {
				case AASPackage.COMPOSABLE_ELEMENT__SUBMODELELEMENT: return AASPackage.CAPABILITY__SUBMODELELEMENT;
				default: return -1;
			}
		}
