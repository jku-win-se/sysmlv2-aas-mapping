...
/**
 * This is the item provider adapter for a {@link AAS.Security} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecurityItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AASPackage.Literals.SECURITY__ACCESS_CONTROL_POLICY_POINTS);
			childrenFeatures.add(AASPackage.Literals.SECURITY__CERTIFICATE);
			childrenFeatures.add(AASPackage.Literals.SECURITY__REQUIRED_CERTIFICATE_EXTENSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AASPackage.Literals.SECURITY__ACCESS_CONTROL_POLICY_POINTS,
				 AASFactory.eINSTANCE.createAccessControlPolicyPoints()));

		newChildDescriptors.add
			(createChildParameter
				(AASPackage.Literals.SECURITY__CERTIFICATE,
				 AASFactory.eINSTANCE.createCertificate()));

		newChildDescriptors.add
			(createChildParameter
				(AASPackage.Literals.SECURITY__REQUIRED_CERTIFICATE_EXTENSION,
