...
/**
 * This is the item provider adapter for a {@link AAS.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends SubmodelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_entityType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_entityType_feature", "_UI_Entity_type"),
				 AASPackage.Literals.ENTITY__ENTITY_TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Entity)object).getIdShort();
