...
/**
 * This is the item provider adapter for a {@link AAS.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider extends ReferableItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AASPackage.Literals.VIEW__CONTAINED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((View)object).getIdShort();
