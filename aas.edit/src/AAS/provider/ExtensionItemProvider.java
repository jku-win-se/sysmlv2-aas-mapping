...
/**
 * This is the item provider adapter for a {@link AAS.Extension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AASPackage.Literals.EXTENSION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addValueTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_valueType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_valueType_feature", "_UI_Extension_type"),
				 AASPackage.Literals.EXTENSION__VALUE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Extension_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Extension_value_feature", "_UI_Extension_type"),
				 AASPackage.Literals.EXTENSION__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Extension.class)) {
			case AASPackage.EXTENSION__NAME:
			case AASPackage.EXTENSION__VALUE_TYPE:
			case AASPackage.EXTENSION__VALUE:
