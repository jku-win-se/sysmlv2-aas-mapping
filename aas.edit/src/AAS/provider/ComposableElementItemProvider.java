...
/**
 * This is the item provider adapter for a {@link AAS.ComposableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComposableElementItemProvider extends SubmodelElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComposableElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ComposableElement)object).getIdShort();
		return label == null || label.length() == 0 ?
			getString("_UI_ComposableElement_type") :
			getString("_UI_ComposableElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComposableElement.class)) {
